...
function appendProperty(
  ...
  if (property.meta && (property.meta.deprecated || property.meta.hidden)) {
    return;
  }
  ...
  if (property.properties) {
    ...
    (property.items.properties ?? []).forEach(subproperty => {
      appendProperty(formattedSchema, subproperty, nestingLevel);
    });
  }
}
...
export function createDescription(property: Property) {
  ...
  if (property.meta && property.meta.regexHuman) {
    propertyDescription += `\n\n` + property.meta.regexHuman;
  }
  if (property.meta && property.meta.genericWorkflow) {
    propertyDescription += `<bareworkflowDetails>${property.meta.genericWorkflow}</bareworkflowDetails>`;
  }
